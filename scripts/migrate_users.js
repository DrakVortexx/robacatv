...
function main() {
  ...
  const gameState = u.gameState || { username, money: 0, cats: [], upgrades: { luck:1, capacity:1 }, startTime: Date.now() };
  // If migrating and money missing, give a sensible default
  if (typeof gameState.money === 'undefined') gameState.money = 100;
    try {
